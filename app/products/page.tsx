...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <div className="min-h-screen">
      <div className="relative mx-auto max-w-[1480px] px-4 pb-12 pt-3 sm:px-5 lg:px-6">
        ...
        <div className="relative lg:pr-[372px]">
          <div className="min-w-0 rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,15,29,0.86),rgba(4,10,22,0.96))] p-4 shadow-[0_28px_80px_rgba(2,6,23,0.28)] backdrop-blur-xl sm:p-6">
